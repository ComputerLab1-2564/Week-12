...
2. ดูประวัติการ commit ทั้งหมดใน repository (ด้วยคำสั่ง ```git log --pretty=format:'%h %ad | %s%d [%an]' --date=short```)
   **คำสั่ง** ให้จับภาพหน้าจอมาวางในใบงาน
   ...
   ![image](https://user-images.githubusercontent.com/92082685/144746137-9dea34ea-7285-4d4a-a821-3a3695b7a02b.png)
...
3. ย้อนไปดูไฟล์ตามประวัติการแก้ไข
  ...
  ![image](https://user-images.githubusercontent.com/92082685/144746392-487f97ed-5889-4069-805d-7488083bb41a.png)
...
4. เราสามารถตั้งชื่อ (tag) ให้กับ commit นี้โดยใช้คำสั่ง ```git tag <tag name>```
  ...
  ![image](https://user-images.githubusercontent.com/92082685/144746431-c7272d25-6f08-4d43-8914-e234ccd81de4.png)
...
6. ทดลอง branch กลับไปยัง commit นั้น โดยใช้ ```git checkout V1```
  ...
  ![image](https://user-images.githubusercontent.com/92082685/144746453-7e95febb-51df-4f71-ab51-6f89e5369ab4.png)
